...
description: Use the OpenCROW steganography stack for hidden-data triage and extraction. Use when an agent needs `steghide`, `zsteg`, or when a full install tracks manual StegSolve or OpenStego setup.
---
