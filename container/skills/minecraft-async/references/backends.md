...
- Keeps managed session metadata under `/tmp/opencrow-minecraft-async/<session>/`
...
- `launcher`: managed launcher stdout/stderr log under `/tmp/opencrow-minecraft-async/<session>/launcher.log`
