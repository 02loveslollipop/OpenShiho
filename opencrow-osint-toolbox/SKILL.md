...
description: Use the OpenCROW OSINT stack for username enumeration, archive lookup, and public search workflows. Use when an agent needs `sherlock`, `waybackpy`, `shodan`, or when a full install tracks manual theHarvester setup.
---
